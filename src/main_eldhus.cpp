...
// OnOffSwitch relay(&conn, RELAY_PIN, "relay", MQTT_TOPIC "/relay");
...
void setup() {
  ...
  DeviceAddress onboardSensor =     {0x28, 0x40, 0x44, 0x0E, 0x05, 0x00, 0x00, 0xBD}; //28:ff:fc:4c:bb:22:2:ac
  DeviceAddress freezerSensor =     {0x28, 0xAA, 0xF3, 0x5D, 0x4B, 0x14, 0x01, 0x59}; //28:aa:f3:5d:4b:14:1:59
  DeviceAddress fridgeSensor =      {0x28, 0xAA, 0xD5, 0x8A, 0x4E, 0x14, 0x01, 0x8f}; //28:aa:d5:8a:4e:14:1:8f
